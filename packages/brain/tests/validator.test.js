...
describe('Brain Response Validator', () => {
    it('should validate a correct and complete response', () => {
        ...
        const { valid, errors } = (0, validator_1.validateBrainResponse)(validResponse);
    ...
    it('should invalidate a response with missing required fields', () => {
        ...
        const { valid } = (0, validator_1.validateBrainResponse)(invalidResponse);
    ...
    it('should validate a minimal correct response', () => {
        ...
        const { valid, errors } = (0, validator_1.validateBrainResponse)(minimalResponse);
        expect(valid).toBe(true);
        expect(errors).toBeNull();
    });
});
